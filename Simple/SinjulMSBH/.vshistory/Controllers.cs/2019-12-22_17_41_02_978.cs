...
namespace Simple.SinjulMSBH
{
	...
	public class CustomersController : ODataController
	{
		...
		[EnableQuery]
		public ActionResult<IReadOnlyList<Customer>> Get()
		{
			...
			return Ok(value: Context.Customers.ToList());
		}

		[EnableQuery]
		public ActionResult<Customer> Get(int key) => Ok(Context.Customers.FirstOrDefault(c => c.Id == key));
	}
